...
#### v1.1（已发布）
- .docx 导入 · .html 导入 · 浅色主题 · 语音输入 + TTS · 网页搜索

#### v1.2（已发布）
- PDF 导出 · .pptx 导入 · .epub 导入 · 自定义嵌入模型上传

#### v1.3（已发布）
- 知识图谱导出 · 文档摘要自动生成 · 快捷指令模板 · 双向链接 · 对话分支树

#### v1.4（已发布）
- Excel/CSV 导入 · 对话全文搜索 · Contextual Retrieval · 文档标签 · 代码模块化

#### v1.5+（候选）
- Late Chunking · MCP 协议支持 · RAG 评估指标 · 多窗口 · Markdown 编辑器
